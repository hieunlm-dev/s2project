            ...
            <ul>
                <li class="fc-info-item">
                    ...
                    <div class="wrap-left-info">
                        ...
                        <p class="fc-desc">Free Shipping in VietNam</p>
                    </div>
                            ...
                            <div class="wrap-contact-detail">
                                <ul>
                                    <li>
                                        ...
                                        <p class="contact-txt">590 Cach mang thang 8 Street, Ward 11, District 3, Hochiminh City, Vietnam</p>
                                    </li>
                                    <li>
                                        <i class="fa fa-phone" aria-hidden="true"></i>
                                        <p class="contact-txt">(+84) 98 157 89 20</p>
                                    </li>
                                    <li>
                                        <i class="fa fa-envelope" aria-hidden="true"></i>
                                        <p class="contact-txt">aptech.fpt@fe.edu.vn</p>
                                    </li>											
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="wrap-footer-item">
                        ...
                        <div class="item-content">
                            <div class="wrap-hotline-footer">
                                ...
                                <b class="phone-number"  >(+84) 98 157 89 20</b>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="item-content">
                            <div class="wrap-newletter-footer">
                                <form action="#" class="frm-newletter" id="frm-newletter">
                                    ...
                                    <button class="btn-submit" style="background:#ff523b">Subscribe</button>
                                </form>
                            </div>
                        </div>
                    </div> --}}
